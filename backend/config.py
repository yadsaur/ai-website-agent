...
MAX_CRAWL_PAGES = int(os.environ.get("MAX_CRAWL_PAGES", "30"))
MAX_CRAWL_DEPTH = int(os.environ.get("MAX_CRAWL_DEPTH", "3"))
MAX_CRAWL_CONCURRENCY = int(os.environ.get("MAX_CRAWL_CONCURRENCY", "2"))
MAX_PAGE_HTML_BYTES = int(os.environ.get("MAX_PAGE_HTML_BYTES", str(900 * 1024)))
